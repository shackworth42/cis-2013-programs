...
if(boolPrinting == true && boolRedLight == false && boolRecognised == false){
    return $("output").value = stringMessage5
}else if(boolPrinting == true && boolRedLight == true && boolRecognised == false){
    return $("output").value = stringMessage5 + "\n" + stringMessage4
}else if(boolPrinting == true && boolRedLight == true && boolRecognised == true){
    return $("output").value = stringMessage2 + "\n" + stringMessage3 + "\n" + stringMessage4
}else if(boolPrinting == true && boolRedLight == false && boolRecognised == true){
    return $("output").value = stringMessage1 + "\n" + stringMessage2 + "\n" + stringMessage3
}else if(boolPrinting == false && boolRedLight == false && boolRecognised == false){
    return $("output").value = stringMessage6
}else if(boolPrinting == false && boolRedLight == false && boolRecognised == true){
    return $("output").value = stringMessage3
}else if(boolPrinting == true && boolRedLight == true && boolRecognised == false){
    return $("output").value = stringMessage4
}else if(boolPrinting == true && boolRedLight == true && boolRecognised == true){
    return $("output").value = stringMessage3 + "\n" + stringMessage4
}}
